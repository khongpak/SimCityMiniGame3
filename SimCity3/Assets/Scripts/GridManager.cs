...
public class GridManager : MonoBehaviour
{
    ...
    */
    ...
    private void PlaceBuilding(Vector2Int pos)
    {
        ...
        6. ตรวจสอบว่า newBuilding มี Component building อยู่ในตัวมันรึเปล่า ถ้ามีให้สร้างตัวแปร b ประเภท building ขึ้นมาเพื่อทำการเชื่อม
            กับ component building ที่อยู่ใน newBuilding 
